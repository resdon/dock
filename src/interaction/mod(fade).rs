...
pub fn update(
    ...
    if state.menu_state.is_open && (off_menu_no_motion || dock_timed_out || window_list_timed_out || context_menu_timed_out) {
    ...
    // 3. Context Menu Fade Target Update (Starts fading out at 1000ms mark)
